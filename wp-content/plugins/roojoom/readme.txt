...
Using this WordPress plugin you can embed any roojoom to your WordPress site using the item URL or item ID.

Choose any item from Roojoom, or create your own! Copy the item URL and paste it to the post text editor. Then simply click over to the visual editor to confirm that it loads properly.
...
5. Add a roojoom sidebar widget.
...
= How do I set custom dimensions to my roojooms? =
