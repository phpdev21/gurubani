				...
				<div class="sp-eap-count-area">
					...
					<div class="count-item">
						...
						if ( isset( $plugin_data['plugins'] ) ) {
							...
							echo esc_attr( $active_downloads['http://wordpress.org/plugins/easy-accordion-free'] );
						} else {
							echo '356559';
						}
						?>
					...
					<div class="count-item">
						...
						<?php
						if ( isset( $plugin_data['plugins'] ) ) {
							$active_ratings = array_column( $plugin_names, 'rating', 'url' );
							echo esc_attr( $active_ratings['http://wordpress.org/plugins/easy-accordion-free'] ) . '/5';
						} else {
							echo '4.8/5';
						}
						?>
			...
			<div class="sp-eap-container">
				...
				<div class="video-area text-center">
					...
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/JEv8hP5NvnY">
			...
			<div class="sp-eap-container">
				...
				<div class="feature-wrapper">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo esc_url( SP_EA_URL . 'admin/css/images/premium/page-builder.svg' ); ?>" alt="">
							</div>
							<div class="feature-content">
								<h3 class="sp-eap-font-18 sp-eap-font-weight-600">Page Builders & Countless Theme Compatibility</h3>
								<p class="sp-eap-font-15 sp-eap-mt-15 sp-eap-line-height-24">The plugin works smoothly with the popular themes and page builders plugins, e,g: Gutenberg, WPBakery, Elementor/Pro, Divi Builder, BeaverBuilder, Fusion Builder, SiteOrigin, Themify Builder, etc.</p>
							</div>
						</div>
						<div class="feature-item ml-30">
							<div class="feature-icon">
